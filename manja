...
// Variables
const rootDomain = "duarebu.web.id"; // Ganti dengan domain utama kalian
const serviceName = "sincan"; // Ganti dengan nama workers kalian
const apiKey = "dc6b7156792657f439212ffd3b4373919f5b8"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "wayziper21@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "275673cc818fbf6780441daff6d0952a"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "b89db83e6fd5d0cc85c9f87d07fcc695"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
